...
class AttentionFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        tk_train.attention_train_backward_causal(q, k, v, o, l_vec, d_vec, grad_output, grad_q, grad_k, grad_v)
...
def measure_performance_bwd_only(b, h, n, d):
    ...
    tflops = efficiency(flops(b, n, d, h, True, "bwd"), time_us)
...
def measure_performance_bwd_fwd(b, h, n, d):
    ...
    time_us = np.mean(times) * 1000
    tflops = efficiency(flops(b, n, d, h, True, "fwd_bwd"), time_us)
